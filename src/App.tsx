  ...
  return (
    <div className="w-full h-screen absolute top-0 bg-contain bg-[url(./assets/BgImage.png)] bg-[#070724]">
      ...
      <div className="flex justify-around content-center gap-[30px] px-[135px] bg-[#070724] text-[#fff] pt-[87px] pb-[56px] uppercase">
        <div className="w-[255px] border-[1px] border-white/20 pl-[23px] py-[20px]">
        ...
        <div className="upercase w-[255px] border-[1px] border-white/20 pl-[23px] py-[20px]">
        ...
        <div className="uppercase w-[255px] border-[1px] border-white/20 pl-[23px] py-[20px]">
